...
import com.zoho.creator.jframework.user.BasicUserStorage;
...
public class ZOHOUser {
    ...
    private ZOHOUser(String uname, String password) {
        Properties  props = new Properties();
        int status = 105;
        String cause = null;
        String result = null;
        try {
            String loginURL = ZCURL.getAuthTokenURL(java.net.URLEncoder.encode(uname, "UTF-8"), java.net.URLEncoder.encode(password, "UTF-8")); //No I18N
    ...
    static ZOHOUser getUserObject(String uname, String password) {
