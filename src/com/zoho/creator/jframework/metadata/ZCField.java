...
public class ZCField implements Comparable<ZCField> {
	...
	public String toString() {
		return "fieldName:" + fieldName + " - type:" + type + " - displayName:" + displayName +  " - compID:" + compID +  //No I18N
				...
				" - fromLocalComputer:" + fromLocalComputer + " - imgLinkReq:" + imgLinkReq + " - altTxtReq:" + altTxtReq + " - refFormLinkName:" + refFormComponent.getComponentLinkName() +  //No I18N
				" - refFormDisplayName:" +  refFormComponent.getComponentName() + " - refAppLinkName:" + refFormComponent.getAppLinkName() + " - refFieldLinkName: " + refFieldLinkName + " - choices:" + choices; //No I18N
	}
	...
	void appendChoices(List<ZCChoice> moreChoices) {
		...
		for(int i=0; i<subFormFields.size(); i++) {
			...
			for(int j=0; j<recordValues.size(); j++) {
				...
				if(recordValueField.getFieldName().equals(subFormRecordValue.getField().getFieldName())) {
					if(FieldType.isChoiceField(recordValueField.getType())) {
