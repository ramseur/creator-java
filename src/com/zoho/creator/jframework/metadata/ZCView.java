...
public class ZCView extends ZCComponent {
	...
	public HashMap<Date, List<ZCRecord>> loadCalendarRecords(int month, int year) {
	...
	public ZCResponse  deleteRecords(List<Long> recordIDs) {
		if(!isDeleteAllowed) {
	...
	public ZCResponse duplicateRecords(List<Long> recordIDs) {
	...
	public String customAction(long customActionID, List<Long> recordIDs) {
