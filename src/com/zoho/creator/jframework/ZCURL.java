...
public class ZCURL {
	...
	public static String getURLForPersonalPhoto(){
		return "https://contacts.zoho.com/file/download?fs=thumb&t=user&ID=" + ZOHOCreator.getUserInfo().getId() + "&authtoken=" + ZOHOCreator.getZohoUser().getAuthToken() + "&scope=creatorapi";
	}
